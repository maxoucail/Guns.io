/**
 * link2me — Input Validator
 * Username, colors, URLs, text sanitization
 */
'use strict';
...
const RESERVED = new Set([
  ...
  'welcome', 'onboarding', 'help', 'support', 'about', 'tos', 'privacy',
  'contact', 'home', 'discord', 'google', 'github', 'callback', 'uploads',
  'css', 'js', 'img', 'images', 'favicon.ico', 'robots.txt', 'sitemap.xml',
  '404', '500', 'terms',
]);
